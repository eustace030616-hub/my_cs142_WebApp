...
class Example extends React.Component {
  ...
  handleMottoChange(event) {
    this.setState({ mottoUpdate: event.target.value});
  }
    ...
    return (
      <div className="container Example">
        ...
        <div className="cs142-motto-update">
          <p>
            {this.state.mottoUpdate ? (
            <p>Motto: {this.state.mottoUpdate}</p>
            ) : <p>Motto: {this.state.motto}</p>}
          </p>

            <p>Name: {this.state.name}</p>

          <label htmlFor="mottoUpdate">update motto:</label>
          <input
            id="mottoUpdate"
            type="text"
            value={this.state.mottoUpdate}
